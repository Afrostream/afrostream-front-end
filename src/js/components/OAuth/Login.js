...
class Login extends React.Component {
  ...
  handleSubmit(event) {
    ...
    const {
      location, modalCallback, dispatch, history
      } = this.props;
  ...
  render() {
    ...
    return (<div className="ui one column center aligned grid">
        <div className="column six wide form-holder">
          <form className="ui large form"
                onSubmit={::this.handleSubmit}
                onChange={::this.handleInputChange}>
            <fieldset className="ui stacked segment">
              <div className="ui small header"> I am a demo, you can type any username / password
              </div>
              <div className={fieldClass}>
                <div className="ui left icon input">
                  <i className="user icon"/>
                  <input key={this.state.timestamp}
                         name="user"
                         type="text"
              ...
              <div className="field">
                <button type="submit"
                        className="ui button large fluid teal">
                  Login
                </button>
              </div >
            </fieldset>
            <div className={errClass}><span>Login Failed</span >
            </div>
          </form>
        </div>
      </div >
