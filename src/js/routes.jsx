...
const buildRoutes = function (lang) {
  ...
  let subRoutes = [
    ...
    <Redirect key={`${lang}-redirect-account-direct`} from={`${(lang && '/' + lang) || ''}/compte/cancel-subscription`}
              to="account/cancel-subscription"/>,
    ...
    <Redirect key={`${lang}-redirect-sponsorship`} from={`${(lang && '/' + lang) || ''}/parrainage/**/*`}
              to="sponsorship"/>,
    <Redirect key={`${lang}-redirect-sponsorship-direct`} from={`${(lang && '/' + lang) || ''}/parrainage`}
              to="sponsorship"/>,
