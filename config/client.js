...
const config = {
  ...
  apiClient: {
    ...
    urlPrefix: (process.env.API_CLIENT_PROTOCOL + '://' + process.env.API_CLIENT_AUTHORITY ) || process.env.API_CLIENT_END_POINT || process.env.API_END_POINT || 'http://localhost:3002',
    token: 'accessToken',
